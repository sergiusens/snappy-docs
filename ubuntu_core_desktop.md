...
Ubuntu Core is delivered in the OS snap (see [Kinds of Snaps](kinds_of_snaps.md "Kinds of Snaps") [Kinds of Snaps 2nd]({% post_url kinds_of_snaps %}) [Kinds of Snaps 3rd]({% post_url /pages/snappy-dev/kinds_of_snaps %}) for more details on these and the other types of snaps: application snaps). 
