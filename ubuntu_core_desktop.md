...
Ubuntu Core is delivered in the OS snap (see [Kinds of Snaps](kinds_of_snaps.md "Kinds of Snaps") [Kinds of Snaps 3rd]({% post_url /snappy-dev/kinds_of_snaps.md %}) for more details on these and the other types of snaps: application snaps). 
